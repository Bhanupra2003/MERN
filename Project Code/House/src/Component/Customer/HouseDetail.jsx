            ...
            {isBookingModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white p-8 rounded-lg shadow-lg w-full md:w-1/3">
                        ...
                        <form onSubmit={handleFormSubmit}>
                            <div className="flex flex-col space-y-4">
                                ...
                                <div className="mt-4">
                                    <button
                                        type="submit"
                                        className="w-full p-2 bg-blue-700 text-white font-serif rounded"
                                    >
                                        Confirm Booking
                                    </button>
                                </div>
                        ...
                        <button onClick={handleBookingClose} className="mt-4 text-center w-full text-blue-600">Close</button>
                    </div>
                </div>
            )}
        </div>
